...
FLUXIONScannerModeQuery="Chọn chế độ cải tiến bộ quét (Scanner)"
FLUXIONScannerOptionStandard="Quét tiêu chuẩn (WPA/WPA2/WPA3)"
FLUXIONScannerOptionHighPower="Quét sóng khỏe (Tăng công suất phát TxPower 30dBm + Đa băng tần)"
FLUXIONScannerOptionAllEnc="Quét tất cả mạng (Bao gồm WPA + Open không mật khẩu + WEP)"
FLUXIONScannerOptionDeep="Quét sâu (Tăng thời gian quét để bắt các mạng ở xa)"
FLUXIONTxPowerBoostingNotice="Đang đẩy công suất phát TxPower card mạng lên tối đa (30dBm / 1000mW)..."
FLUXIONSignalStrong="Mạnh"
FLUXIONSignalMedium="Trung bình"
FLUXIONSignalWeak="Yếu"
# >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
